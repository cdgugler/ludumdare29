CrashLanding.Util.mobileGamePad = function mobileGamePad(game, state) {
    ...
    if (!game.device.desktop) { 
        game.buttonA = game.add.button(game.width - 70, game.height - 68, 'sprites', null, state, 'a-button', 'a-button', 'a-button', 'a-button');
        ...
        game.buttonLeft = game.add.button(12, game.height - 68, 'sprites', null, state, 'left', 'left', 'left', 'left');
        ...
        game.buttonRight = game.add.button(88, game.height - 68, 'sprites', null, state, 'right', 'right', 'right', 'right');
